...
import ms.main.model.vo.MovieVO;
...
public class MainService {
	...
	public Map<String, Object> selectMainContent() throws SQLException {
		...
		List<MovieVO> movieList = mainDAO.selectMainContent();		// 메인 컨텐츠 조회

package main.java.ms.main.model.vo;
...
public class MovieVO {
	...
	public MovieVO(String movieNo, String movieTitle, String movieEngTitle, String movieTime, String movieOpenDate, double movieScore, String movieNational, String movieGrade, String moviePoster, String moviePreview) {
		super();
	...
	public String toString() {
		return "MovieInfoVO [movieNo=" + movieNo + ", movieTitle=" + movieTitle + ", movieEngTitle=" + movieEngTitle

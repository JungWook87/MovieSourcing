...
const qnaList = [
  {
    ...
    a: [
      { answer: 'a. 알콩달콩 애인과의 데이트', type: [3, 15, 0] },
      { answer: 'b. 왁자지껄 친구들과 떠나는 재밌는 여행', type: [15, 12, 11] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 버스기다리느라 시간 걸리고, 차도 막히고 차라리 튼튼한 내 두 다리를 믿고 뛰겠어!!', type: [16, 11,10,2,4] },
      { answer: 'b. 아무리 그래도 뛰는 것보다는 버스를 타거나 택시타고 가는게 빠르지 않겠어??      ', type: [17,3] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 원투펀치!!! 옆차기!! 뒤돌려차기!! 두 남자가 상대방을 죽일듯이 싸우고 있다!!', type: [11,6,] },
      { answer: 'b. 세상에!! 옆건물 태권도장이랑 앞건물 합기도장 단원들이 단체로 싸우고 있다니…', type: [6, 14,10,16] },
    ]
  },
  {
    ...
    a: [
      { answer: 'a. 누군가의 시체 ', type: [1, 9, 5, 6 ] },
      { answer: 'b. 커다란 곰 인형 ', type: [15, 12, 2, 10 ] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 끔찍하다.. 생각하고 싶지 않다.. 술먹고 다 잊어야지', type: [12, 16, 3 ] },
      { answer: 'b. 누가 범인일까?? 어떻게 죽은거지?? 호기심이 일어난다.', type: [9, 1, 6, 5, 4 ]},
...

  {
    ...
    a: [
      { answer: 'a. 바다에 큰 파도가 출렁거리고 시원한 바람이 세차게 불고 있다', type: [11, 17, 3, 7 ] },
      { answer: 'b. 잔잔한 바다.. 저멀리 노을이 지고 있다', type: [0, 2 ,3 , 16 ] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 이게 뭘까?? 호기심이 가득해진 당신', type: [16,17,12,10,8, ] },
      { answer: 'b. 세상에 이딴게 어딨어… 내가 잠이 덜 깼나보군.. 다시 자야지..', type: [2, 3, 0 ] },
    ]
  },
  {
    q: '오랜만에 갖게 된 휴일~<br>'+
    '오늘 뭐 하면서 시간을 보낼까??',
    a: [
      { answer: 'a. 집에서 재밌는거나 보면서 휴식하자', type: [3, 2 ,15 , 10 ] },
      { answer: 'b. 오랜만에 밖으로 나가서 취미 활동 좀 해볼까??', type: [11,17, 14,9 ] },
    ]
  },
  {

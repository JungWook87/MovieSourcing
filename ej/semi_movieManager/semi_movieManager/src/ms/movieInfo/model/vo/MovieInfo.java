...
public class MovieInfo {
	...
	public MovieInfo(String movieTitle, String movieEngTitle, String movieTime, String movieOpenDate, double movieScore,
			String movieNational, String movieGrade, String moviePoster, String moviePreview) {
		super();
	...
	public String toString() {
		return "MovieInfo [movieTitle=" + movieTitle + ", movieEngTitle=" + movieEngTitle + ", movieTime=" + movieTime
				+ ", movieOpenDate=" + movieOpenDate + ", movieScore=" + movieScore + ", movieNational=" + movieNational
				+ ", movieGrade=" + movieGrade + ", moviePoster=" + moviePoster + ", moviePreview=" + moviePreview
				+ "]";
	}

...
public class sendEmailServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fromEmail = "backbackdh@gmail.com"; // 보내는 사람으로 표시될 이메일 (이메일 따라서 안될수도 있음)
		...
		final String smtpEmail = "backbackdh@gmail.com"; // 이메일
		final String password = "dfugrvprjbgeqwra"; // 발급 받은 비밀번호

        ...
        <div id="layout">
            <div id="root">
                ...
                <main id="contents">
                    ...
                    <section class="infomationbox" onsubmit="return signUpValidate()">
                        <div class="infomation">
                            <div class="idwrap">
                                <span>아이디</span>
                                <div class="idinput">
                                    <input type="text" id="id" name = "id" placeholder="아이디를 입력해주세요" autocomplete="off" required>
                            ...
                            <div class="pwwrap1">
                                ...
                                <div class="pwinput1">
                                    <input type="password" id="pw1" name = "pw1" placeholder="영문/숫자/특수문자 포함 8자리 이상 입력" autocomplete="off" required>
                                </div>
                            ...
                            <div class="pwwrap1">
                                <span>비밀번호확인</span>
                                <div class="pwinput2">
                                    <input type="password" id="pw2"  placeholder="영문/숫자/특수문자 포함 8자리 이상 입력" autocomplete="off" required >
                                </div>
                            </div>
                            <div class="nicknamewrap">
                                <span>닉네임</span>
                                <div class="nicknameinput">
                                    <input type="text" id="nickname" name = "nickname" placeholder="한글 영어 숫자로 12자이내로 정해주세요" autocomplete="off" required>
                                    <div class="dupcheckbox">
                            ...
                            <div class="genderbox">
                                <span>성별</span>
                                <div>
                                    <label for="M"><span>남성</span></label> <input type="radio" name="gender" id="M" value="M" onclick="fnRadioName();">
                                    <label for="F"><span>여성</span></label> <input type="radio" name="gender" id="F" value="F" onclick="fnRadioName();">
                                </div>
